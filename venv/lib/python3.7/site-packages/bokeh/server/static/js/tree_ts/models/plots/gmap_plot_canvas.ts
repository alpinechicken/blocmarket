...
export var GMapPlotCanvasView = (function(superClass) {
  ...
  GMapPlotCanvasView.prototype.getProjectedBounds = function() {
    ...
    ref1 = proj4(mercator, [xstart, ystart]), proj_xstart = ref1[0], proj_ystart = ref1[1];
    ref2 = proj4(mercator, [xend, yend]), proj_xend = ref2[0], proj_yend = ref2[1];
...
export var GMapPlotCanvas = (function(superClass) {
