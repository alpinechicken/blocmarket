...
import {
  ColumnDataSource
} from "./models/sources/column_data_source";

export var DocumentChangedEvent = (function() {
...
export var ModelChangedEvent = (function(superClass) {
...
export var TitleChangedEvent = (function(superClass) {
...
export var RootAddedEvent = (function(superClass) {
...
export var RootRemovedEvent = (function(superClass) {
...
export var DEFAULT_TITLE = "Bokeh Application";
...
export var Document = (function() {
  ...
  Document.prototype.add_root = function(model, setter_id) {
    ...
    this._init_solver();
    return this._trigger_on_change(new RootAddedEvent(this, model, setter_id));
  };
  ...
  Document.prototype.remove_root = function(model, setter_id) {
    ...
    this._init_solver();
    return this._trigger_on_change(new RootRemovedEvent(this, model, setter_id));
  };
  ...
  Document.prototype.set_title = function(title, setter_id) {
    if (title !== this._title) {
      this._title = title;
      return this._trigger_on_change(new TitleChangedEvent(this, title, setter_id));
    }
  };
  ...
  Document.prototype._notify_change = function(model, attr, old, new_, options) {
    ...
    return this._trigger_on_change(new ModelChangedEvent(this, model, attr, old, new_, options != null ? options.setter_id : void 0));
  };
      ...
      switch (event_json.kind) {
        case 'ModelChanged':
          ...
          if (attr === 'data' && model_type === 'ColumnDataSource') {
            ref1 = decode_column_data(event_json['new']), data = ref1[0], shapes = ref1[1];
