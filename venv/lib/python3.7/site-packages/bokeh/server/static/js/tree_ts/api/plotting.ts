var _default_tools, _default_tooltips, _known_tools, _with_default,
...
export var Figure = (function(superClass) {
  ...
  Figure.prototype._glyph = function(cls, params, args) {
    ...
    has_sglyph = _.any(_.keys(attrs), function(key) {
      return startsWith(key, "selection_");
    });
    has_hglyph = _.any(_.keys(attrs), function(key) {
      return startsWith(key, "hover_");
    });
...
export var figure = function(attributes, options) {
  if (attributes == null) {
    attributes = {};
  }
  if (options == null) {
...
export var show = function(obj, target) {
...
export var color = function(r, g, b) {
  return sprintf("#%02x%02x%02x", r, g, b);
};

export var gridplot = function(children, options) {
