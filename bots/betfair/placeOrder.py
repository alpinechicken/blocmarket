...
#from betfair.listMarketCatalogue import listMarketCatalogue
#from betfair.listMarketBook import listMarketBook
...
def placeOrder(sessionKey,appKey,**kwargs):
    ...
    marketId = json.dumps(inputParams['marketId'])
    ...
    content= {"jsonrpc": "2.0",
              ...
              "params": {"marketId": inputParams['marketId'],
                        "instructions": [{"orderType": inputParams['orderType'],
                                         "selectionId": inputParams['selectionId'],
                                         "handicap": 0,
                                         "side": "LAY",
                                         "limitOrder": {"size": betSize,
                                                        "price": betPrice,
                                                        "persistenceType": inputParams['persistenceType']}},
...
resp = placeOrder(sessionKey,liveAppKey,marketId=marketId,selectionId=selectionId,orderType='LIMIT',side='BACK',wallet=wallet,price=oddsToPlace,size=5,persistenceType='LAPSE')
'''
