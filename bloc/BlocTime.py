...
class BlocTime(object):
    ...
    def __init__(self):
        ...
        self.verifyKey = 'cdcfb59431b2579a681cee65656cbed6f8d578d5cc30d3e759e86c1d3e3529ef'
    ...
    def signedUTCNow(self):
        ...
        return {'timeStampUTC': str(timeStampUTC), 'timeStampUTCSignature': timeStampUTC_signed.signature, 'verifyKey': self.verifyKey}
