...
class BlocBot(object):
    ...
    def __init__(self):
        ...
        self.sourceurl = 'https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=BTC&to_currency=USD&apikey=VVOJSV9CUU9JRCSE'
        self.sourceheaders = {}
    ...
    def getQuote(self):        
        ...
        response = requests.get(self.sourceurl, headers=self.sourceheaders)
    ...
    def streamQuote(self):
        ...
        while stillQuoting:
            ...
            if prevQuote == quotePrice:
                ...
                # Make quote
                cbid = self.makeQuote(bidPrice, 1)
                cask = self.makeQuote(askPrice, -1)
                ...
                if bidTdId not in ts[ts['iMatched']]:
                    self.makeQuote(bidPrice, -1)
                
                if askTdId not in ts[ts['iMatched']]:
                    self.makeQuote(askPrice, 1)
